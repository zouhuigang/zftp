...
<!-- Template /skins/shinra/footer_versioncheck.template.php begin -->
<table border="0" cellspacing="0" cellpadding="0" style="margin-left: auto; margin-right: auto; margin-top: 20px;">
	<tr>
		<td style="text-align: center;">
			...
			<?php echo __("Powered by"); ?> <a href="http://www.net2ftp.com">net2ftp</a>在线FTP客户端<br /><br />
...
<!-- Template /skins/shinra/footer_versioncheck.template.php end -->
