...
<table id="maintable" >
	<tr class="browse_rows_actions">
		<td colspan="<?php echo $total_colspan; ?>">
			<table><tr><td valign="top" style="text-align: <?php echo __("left"); ?>;">
...
<td valign="top" style="text-align: <?php echo __("right"); ?>;">
...
// ----- Some PHP stuff -----
			...
			if ($list_directories[$i]["selectable"] == "ok") { 
				...
				$style = "cursor: pointer; cursor: hand; min-width: 16px; width: 32px; max-width: 300px;"; 
...
// -------------------------- ?>
			<tr class="browse_rows_<?php echo $odd_even; ?>" id="row<?php echo $rowcounter; ?>" onmouseover="this.style.color='#FFF'; this.style.backgroundColor='#363636';" onmouseout="this.style.color='#696969'; setColor_js(<?php echo $rowcounter; ?>, '<?php echo $checkbox_hidden; ?>');">
				<td title="<?php echo __("Select the file %1\$s", $list_files[$i]["dirfilename_html"]); ?>" style="text-align: center; width: 32px; overflow: hidden;">
